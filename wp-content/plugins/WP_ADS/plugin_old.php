				 ...
				 .containerMain .col{
					...
					.btn {
							...
							.wc-wp-version-gte-53 .select2-dropdown--below {
								...
								.ad_expire{color:#000;font-size:10px;}
								.view_main a{font-size:12px;}
						</style>
              ...
              <div class="containerMain">
                <div class="container">
                  ...
                  <?php for($i = 1;$i <= 10;$i++){ 
					...
					$ad_demo_company_name1_title = ADS_List::shorten_title($ad_demo_company_name1,$title_lenght)."<br /><span class='ad_expire'>".$date_array1[1].'</span>';
					$date_array2 = explode(" – ",html_entity_decode(get_the_title(get_option($option_name2)))); 
					$ad_demo_company_name2_title = ADS_List::shorten_title($ad_demo_company_name2,$title_lenght)."<br /><span class='ad_expire'>".$date_array2[1].'</span>';
					$date_array3 = explode(" – ",html_entity_decode(get_the_title(get_option($option_name3)))); 
					$ad_demo_company_name3_title = ADS_List::shorten_title($ad_demo_company_name3,$title_lenght)."<br /><span class='ad_expire'>".$date_array3[1].'</span>';
					$date_array4 = explode(" – ",html_entity_decode(get_the_title(get_option($option_name4)))); 
					$ad_demo_company_name4_title = ADS_List::shorten_title($ad_demo_company_name4,$title_lenght)."<br /><span class='ad_expire'>".$date_array4[1].'</span>';
