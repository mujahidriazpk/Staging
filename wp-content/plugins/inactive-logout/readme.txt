...
Upgrade to **[Inactive Logout Pro](https://inactive-logout.com/buy/ "Inactive Logout Pro")** for:
...
**See the [Inactive Logout](https://inactive-logout.com/ "Inactive Logout") homepage for further information. Contact Developer for those who need to write plugins.**
