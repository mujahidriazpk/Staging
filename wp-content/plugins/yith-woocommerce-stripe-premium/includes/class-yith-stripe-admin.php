	...
	class YITH_WCStripe_Admin {
		...
		public function add_notices() {
            ...
            <div class="notice notice-warning">
                ...
                <p class="submit">
                    <a class="button-secondary" href="<?php echo add_query_arg( array( 'action' => 'yith_wcstripe_handle_warning_state', 'request' => 'keep_test' ), admin_url( 'admin.php' ) ) ?>"><?php _e( 'Keep test mode', 'yith-woocommerce-stripe' ) ?></a>
                    <a class="button-secondary" href="<?php echo add_query_arg( array( 'action' => 'yith_wcstripe_handle_warning_state', 'request' => 'set_live' ), admin_url( 'admin.php' ) ) ?>"><?php _e( 'Set live mode', 'yith-woocommerce-stripe' ) ?></a>
                </p>
            </div>
            <?php
		}
