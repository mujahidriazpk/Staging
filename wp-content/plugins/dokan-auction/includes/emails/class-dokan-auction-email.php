...
class Dokan_Auction_Email extends WC_Email {
	...
	public function __construct() {
		...
		$this->title            = __( 'Dokan New Auction', 'dokan-auction' );
		$this->description      = __( 'This email is sent to admin and vendor when a new auction product is added', 'dokan-auction' );
	...
	public function get_default_subject() {
        return __( '[{site_name}] A new auction product is added by ({seller_name}) - {product_title}', 'dokan-auction' );
	}
	...
	public function get_default_heading() {
        return __( 'New auction product is added by Vendor {seller_name}', 'dokan-auction' );
	}
	...
	public function init_form_fields() {
		$this->form_fields = array(
			'enabled' => array(
				'title'         => __( 'Enable/Disable', 'dokan-auction' ),
				'type'          => 'checkbox',
				'label'         => __( 'Enable this email notification', 'dokan-auction' ),
				'default'       => 'yes',
			),
			'recipient' => array(
				'title'         => __( 'Recipient(s)', 'dokan-auction' ),
				'type'          => 'text',
				'description'   => sprintf( __( 'Enter recipients (comma separated) for this email. Defaults to %s.', 'dokan-auction' ), '<code>' . esc_attr( get_option( 'admin_email' ) ) . '</code>' ),
				'placeholder'   => '',
				'default'       => '',
				'desc_tip'      => true,
			),	
			'subject' => array(
				'title'         => __( 'Subject', 'dokan-auction' ),
				'type'          => 'text',
				'desc_tip'      => true,
				/* translators: %s: list of placeholders */
				'description'   => sprintf( __( 'Available placeholders: %s', 'dokan-auction' ), '<code>{blogname}</code>' ),
				'placeholder'   => $this->get_default_subject(),
				'default'       => '',
			),
			'heading' => array(
				'title'         => __( 'Email heading', 'dokan-auction' ),
				'type'          => 'text',
				'desc_tip'      => true,
				/* translators: %s: list of placeholders */
				'description'   => sprintf( __( 'Available placeholders: %s', 'dokan-auction' ), '<code>{product_title}</code>' ),
				'placeholder'   => $this->get_default_heading(),
				'default'       => '',
			),
			'email_type' => array(
				'title'         => __( 'Email type', 'dokan-auction' ),
				'type'          => 'select',
				'description'   => __( 'Choose which format of email to send.', 'dokan-auction' ),
				'default'       => 'html',
