...
<?php
    ...
    <header class="dokan-dashboard-header dokan-clearfix">
        <h1 class="entry-title">
            ...
            <span class="dokan-label dokan-label-default"><?php _e( 'Hidden', 'dokan-auction' ); ?></span>
            <?php } ?>

            <?php if ( $post->post_status == 'publish' ) { ?>
            <span class="dokan-right">
                <a class="view-product dokan-btn dokan-btn-sm" href="<?php echo get_permalink( $post->ID ); ?>" target="_blank"><?php _e( 'View Product', 'dokan-auction' ); ?></a>
            </span>
            <?php } ?>
        </h1>
    </header>
    ...
    <div class="dokan-new-product-area">
        <?php if ( isset( $_GET['message'] ) && $_GET['message'] == 'success') { ?>
            <div class="dokan-message">
                ...
                <strong><?php _e( 'Success!', 'dokan-auction' ); ?></strong> <?php _e( 'The product has been updated successfully.', 'dokan-auction' ); ?>

                <?php if ( $post->post_status == 'publish' ) { ?>
                <a href="<?php echo get_permalink( $post_id ); ?>" target="_blank"><?php _e( 'View Product &rarr;', 'dokan-auction' ); ?></a>
                <?php } ?>
            </div>
        <?php } ?>
        ...
        <form class="dokan-form-container dokan-auction-product-form" role="form" method="post">
            ...
            <div class="product-edit-container dokan-clearfix">
                ...
                <div id="edit-product">
                        ...
                        <div class="content-half-part featured-image">
                            <div class="dokan-feat-image-upload">
                                ...
                                <div class="instruction-inside<?php echo $instruction_class; ?>">
                                    ...
                                    <a href="#" class="dokan-feat-image-btn btn btn-sm"><?php _e( 'Upload a product cover image', 'dokan-auction' ); ?></a>
                                </div>
                                                ...
                                                if ( $gallery ) {
                                                    foreach ($gallery as $image_id) {
                                                        ...
                                                        <li class="image" data-attachment_id="<?php echo $image_id; ?>">
                                                            ...
                                                            <a href="#" class="action-delete" title="<?php esc_attr_e( 'Delete image', 'dokan-auction' ); ?>">&times;</a>
                                                        </li>
                                                        <?php
                                                    }
                                                }
                        ...
                        <div class="content-half-part dokan-product-meta">
                            ...
                            <?php if ( dokan_get_option( 'product_category_style', 'dokan_selling', 'single' ) == 'single' ): ?>
                                <div class="dokan-form-group dokan-auction-category">
                                    <label for="product_cat" class="form-label"><?php _e( 'Category', 'dokan-auction' ); ?></label>
                                    <?php
                                    $product_cat = -1;
                                    $term = array();
                                ...
                                ?>
                                    <div class="dokan-product-cat-alert dokan-hide">
                                        <?php _e('Please choose a category!', 'dokan-auction'); ?>
                                    </div>
                                </div>
                            ...
                            <div class="dokan-form-group dokan-auction-tags">
                                <label for="product_tag" class="form-label"><?php _e( 'Tags', 'dokan-auction' ); ?></label>
                                <?php
                    ...
                    <div class="product-edit-new-container">
                                    ...
                                    <div class="dokan-form-group">
                                        ...
                                        <div class="dokan-form-group">
                                            <select name="_auction_item_condition" class="dokan-form-control" id="_auction_item_condition">
                                                <option value="new" <?php echo ( $_auction_item_condition == 'new' ) ? 'selected' : '' ?>><?php _e( 'New', 'dokan-auction' ) ?></option>
                                                <option value="used" <?php echo ( $_auction_item_condition == 'used' ) ? 'selected' : '' ?>><?php _e( 'Used', 'dokan-auction' ) ?></option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="dokan-form-group">
                                        ...
                                        <div class="dokan-form-group">
                                            <select name="_auction_type" class="dokan-form-control" id="_auction_type">
                                                <option value="normal" <?php echo ( $_auction_type == 'normal' ) ? 'selected' : '' ?>><?php _e( 'Normal', 'dokan-auction' ) ?></option>
                                                <option value="reverse" <?php echo ( $_auction_type == 'reverse' ) ? 'selected' : '' ?>><?php _e( 'Reverse', 'dokan-auction' ) ?></option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="dokan-edit-row dokan-auction-other-sections dokan-clearfix">
                            <div class="dokan-section-heading" data-togglehandler="dokan_other_options">
                                <h2><i class="fa fa-cog" aria-hidden="true"></i> <?php _e( 'Other Options', 'dokan-auction' ); ?></h2>
                                <p><?php _e( 'Set your extra product options', 'dokan-auction' ); ?></p>
                                <div class="dokan-clearfix"></div>
                            </div>

                            <div class="dokan-section-content">
                                <div class="dokan-form-group content-half-part dokan-auction-product-status">
                                    <label for="post_status" class="form-label"><?php _e( 'Product Status', 'dokan-auction' ); ?></label>
                                    <?php if ( $post_status != 'pending' ) { ?>
                                        <?php $post_statuses = apply_filters( 'dokan_post_status', array(
                                            'publish' => __( 'Online', 'dokan-auction' ),
                                            'draft'   => __( 'Draft', 'dokan-auction' )
                                        ), $post ); ?>
                                ...
                                <div class="dokan-form-group content-half-part dokan-auction-product-visibility">
                                    <label for="_visibility" class="form-label"><?php _e( 'Visibility', 'dokan-auction' ); ?></label>
                                ...
                                <div class="dokan-form-group dokan-auction-post-content">
                                    <label for="post_content" class="form-label"><?php _e( 'Description', 'dokan-auction' ); ?></label>
                    ...
                    <input type="submit" name="update_auction_product" class="dokan-btn dokan-btn-theme dokan-btn-lg dokan-right" value="<?php esc_attr_e( 'Update Product', 'dokan-auction' ); ?>"/>
