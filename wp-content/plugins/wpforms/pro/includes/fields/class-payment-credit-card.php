			...
			'inputs' => array(
				'number' => array(
					...
					'sublabel' => array(
						...
						'value'    => 'Card Number <span class="wpforms-required-label">*</span>',
						'position' => 'before',
					),
				),
				'cvc'    => array(
					...
					'sublabel' => array(
						'hidden'   => ! empty( $field['sublabel_hide'] ),
						'value'    => 'Security Code <a href="#cvv-suggestion" class="cvv2-help" rel="prettyPhoto"><strong>What is my CVC code?</strong></a> <span class="wpforms-required-label">*</span>',//esc_html__( 'Security Code<a>test</a>', 'wpforms' ),
						'position' => 'before',
					),
				),
				'name'   => array(
				...
				'month'  => array(
					...
					'sublabel' => array(
						'hidden'   => ! empty( $field['sublabel_hide'] ),
						'value'    => 'Expiration <span class="wpforms-required-label" style="float:none;line-height:16px;">*</span>',
						'position' => 'before',
					),
				),
				'year'   => array(
		...
		echo '<div class="wpforms-field-row wpforms-field-' . sanitize_html_class( $field['size'] ) . '">';
			...
			echo '<div class="wpforms-field-credit-card-expiration">';
				...
				foreach ( range( 1, 12 ) as $number ) {
					printf( '<option value="%d">%s</option>', $number, str_pad($number,2,'0',STR_PAD_LEFT));
				}
				echo '</select>';
