(function($, window){
                    ...
                    complete: function(results) {
                        if(results.errors.length === 0){
                            ...
                            if  ((results.errors.length === 1) && (results.errors[0].code === "UndetectableDelimiter")){
                                ...
                                var fieldNameIsCorrect = typeof _this.database.schema.getField(fieldName) != 'undefined';
    ...
    MapSVGAdminDatabaseCsvController.prototype.import = function(data, convertLatlngToAddress){
        ...
        btn._button('loading');
        var res = _this.database.import(data, convertLatlngToAddress).done(function(data){
